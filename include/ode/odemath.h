...
ODE_PURE_INLINE void dVolatileMultiplyHelper0_331(volatile dReal *res, const dReal *a, const dReal *b)
{
    const dReal res_0 = dCalcVectorDot3(a, b);
    const dReal res_1 = dCalcVectorDot3(a + 4, b);
    const dReal res_2 = dCalcVectorDot3(a + 8, b);
...
ODE_PURE_INLINE void dVolatileMultiplyHelper1_331(volatile dReal *res, const dReal *a, const dReal *b)
{
    const dReal res_0 = dCalcVectorDot3_41(a, b);
    const dReal res_1 = dCalcVectorDot3_41(a + 1, b);
    const dReal res_2 = dCalcVectorDot3_41(a + 2, b);
...
ODE_PURE_INLINE void dVolatileMultiplyHelper0_133(volatile dReal *res, const dReal *a, const dReal *b)
{
    dVolatileMultiplyHelper1_331(res, b, a);
}
...
{
    dVolatileMultiplyHelper0_331(res, a, b);
}
...
{
    dVolatileMultiplyHelper1_331(res, a, b);
}
...
{
    dVolatileMultiplyHelper0_133(res, a, b);
}
